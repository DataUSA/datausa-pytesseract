...
<html lang="en">
<head><meta charset=utf-8><title>Tesseract Python API DataUSA</title><meta http-equiv="Refresh" content="0; url='/ui/'" /></head>
<body><h1>Tesseract Python API DataUSA</h1><p><a href="/ui/">DataExplorer</a></p><p style="opacity:0.5">{commit_hash}</p></body>
</html>
"""
